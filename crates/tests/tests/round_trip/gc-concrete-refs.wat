...
(; CHECK-ALL:
  (module
    ...
    (type $wrapper (;1;) (struct (field i32) (field (ref null $point))))
    (type (;2;) (func (result (ref null $point))))
    (type (;3;) (func (param (ref null $point) (ref null $point) i32) (result (ref null $point))))
    (type (;4;) (func (result (ref null $wrapper))))
    (type (;5;) (func (param i32) (result (ref null $point))))
    (type (;6;) (func (param i32) (result (ref null $wrapper))))
    (import "env" "struct_table" (table $st (;0;) 5 (ref null $point)))
    (import "env" "ext_point" (global $ext_point (;0;) (ref null $point)))
    (table $local_tbl (;1;) 10 (ref null $wrapper))
    (global (;1;) (ref null $point) ref.null $point)
    ...
    (func (;0;) (type 3) (param (ref null $point) (ref null $point) i32) (result (ref null $point))
      local.get 0
      local.get 1
      local.get 2
      select (result (ref null $point))
    )
    (func (;1;) (type 5) (param i32) (result (ref null $point))
      local.get 0
      table.get $st
    )
    (func (;2;) (type 6) (param i32) (result (ref null $wrapper))
      local.get 0
      table.get $local_tbl
    )
    (func (;3;) (type 2) (result (ref null $point))
      ref.null $point
    )
    (func (;4;) (type 4) (result (ref null $wrapper))
      (local (ref null $wrapper))
      local.get 0
    )
