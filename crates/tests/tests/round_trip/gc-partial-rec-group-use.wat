...
(; CHECK-ALL:
  (module
    (rec
      ...
      (type $branch (;2;) (sub final $tree (struct (field i32) (field (ref null $tree)) (field (ref null $tree)))))
    )
    (type (;3;) (func (param (ref null $tree)) (result i32)))
    (export "get_tag" (func 0))
    (func (;0;) (type 3) (param (ref null $tree)) (result i32)
      local.get 0
      struct.get $tree 0
    )
  )
