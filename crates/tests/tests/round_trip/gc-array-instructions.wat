...
(; CHECK-ALL:
  (module
    ...
    (type (;2;) (func (param i32 i32) (result (ref $i32_array))))
    (type (;3;) (func (param i32) (result (ref $i32_array))))
    (type (;4;) (func (result (ref $i32_array))))
    (type (;5;) (func (param (ref null $i32_array) i32) (result i32)))
    (type (;6;) (func (param (ref null $i32_array) i32 i32)))
    (type (;7;) (func (param (ref null $i32_array)) (result i32)))
    (type (;8;) (func (param (ref null $byte_array) i32) (result i32)))
    (type (;9;) (func (param (ref null $byte_array) i32 i32)))
    (type (;10;) (func (param (ref null $i32_array) i32 i32 i32)))
    (type (;11;) (func (param (ref null $i32_array) i32 (ref null $i32_array) i32 i32)))
    ...
    (export "fill" (func 1))
    (export "copy" (func 0))
    (func (;0;) (type 11) (param (ref null $i32_array) i32 (ref null $i32_array) i32 i32)
      local.get 0
      local.get 1
      local.get 2
      local.get 3
    ...
    (func (;1;) (type 10) (param (ref null $i32_array) i32 i32 i32)
      local.get 0
      local.get 1
      local.get 2
      local.get 3
    ...
    (func (;2;) (type 4) (result (ref $i32_array))
      i32.const 10
      i32.const 20
      i32.const 30
      array.new_fixed $i32_array 3
    )
    (func (;3;) (type 6) (param (ref null $i32_array) i32 i32)
      local.get 0
      local.get 1
      local.get 2
      array.set $i32_array
    )
    (func (;4;) (type 9) (param (ref null $byte_array) i32 i32)
      local.get 0
      local.get 1
      local.get 2
      array.set $byte_array
    )
    (func (;5;) (type 2) (param i32 i32) (result (ref $i32_array))
      local.get 0
      local.get 1
      array.new $i32_array
    )
    (func (;6;) (type 5) (param (ref null $i32_array) i32) (result i32)
      local.get 0
      local.get 1
      array.get $i32_array
    )
    (func (;7;) (type 8) (param (ref null $byte_array) i32) (result i32)
      local.get 0
      local.get 1
      array.get_s $byte_array
    )
    (func (;8;) (type 8) (param (ref null $byte_array) i32) (result i32)
      local.get 0
      local.get 1
      array.get_u $byte_array
    )
    (func (;9;) (type 3) (param i32) (result (ref $i32_array))
      local.get 0
      array.new_default $i32_array
    )
    (func (;10;) (type 7) (param (ref null $i32_array)) (result i32)
      local.get 0
      array.len
    )
;)
