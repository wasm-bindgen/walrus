...
(; CHECK-ALL:
  (module
    ...
    (type (;2;) (func (param (ref null $point)) (result f64)))
    (import "env" "ext" (global $ext (;0;) externref))
    (import "env" "any" (global $any (;1;) anyref))
    (global (;2;) (ref $point) struct.new_default $point)
    (global (;3;) (ref $point) f64.const 0x1p+0 (;=1;) f64.const 0x1p+1 (;=2;) struct.new $point)
    (global (;4;) (ref $iarr) i32.const 10 array.new_default $iarr)
    (global (;5;) (ref $iarr) i32.const 42 i32.const 5 array.new $iarr)
    (global (;6;) (ref $iarr) i32.const 1 i32.const 2 i32.const 3 array.new_fixed $iarr 3)
    ...
    (func (;0;) (type 2) (param (ref null $point)) (result f64)
      local.get 0
      struct.get $point 0
    )
  )
