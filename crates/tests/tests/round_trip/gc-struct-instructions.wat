...
(; CHECK-ALL:
  (module
    ...
    (type (;2;) (func (param f64 f64) (result (ref $point))))
    (type (;3;) (func (result (ref $point))))
    (type (;4;) (func (param (ref null $point)) (result f64)))
    (type (;5;) (func (param (ref null $point) f64)))
    (type (;6;) (func (param (ref null $packed)) (result i32)))
    (type (;7;) (func (param (ref null $packed) i32)))
    ...
    (func (;0;) (type 2) (param f64 f64) (result (ref $point))
      local.get 0
      local.get 1
      struct.new $point
    )
    (func (;1;) (type 5) (param (ref null $point) f64)
      local.get 0
      local.get 1
      struct.set $point 0
    )
    (func (;2;) (type 7) (param (ref null $packed) i32)
      local.get 0
      local.get 1
      struct.set $packed 0
    )
    (func (;3;) (type 4) (param (ref null $point)) (result f64)
      local.get 0
      struct.get $point 0
    )
    (func (;4;) (type 6) (param (ref null $packed)) (result i32)
      local.get 0
      struct.get_s $packed 0
    )
    (func (;5;) (type 6) (param (ref null $packed)) (result i32)
      local.get 0
      struct.get_u $packed 0
    )
    (func (;6;) (type 6) (param (ref null $packed)) (result i32)
      local.get 0
      struct.get_s $packed 1
    )
    (func (;7;) (type 6) (param (ref null $packed)) (result i32)
      local.get 0
      struct.get_u $packed 1
    )
    (func (;8;) (type 6) (param (ref null $packed)) (result i32)
      local.get 0
      struct.get $packed 2
    )
