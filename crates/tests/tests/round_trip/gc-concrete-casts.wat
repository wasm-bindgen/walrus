...
(; CHECK-ALL:
  (module
    ...
    (type (;2;) (func (param (ref null $base)) (result i32)))
    (type (;3;) (func (param (ref null $base)) (result (ref $derived))))
    (type (;4;) (func (param (ref null $base)) (result (ref null $derived))))
    ...
    (func (;0;) (type 2) (param (ref null $base)) (result i32)
      block (result (ref null $derived)) ;; label = @1
        local.get 0
        br_on_cast 0 (;@1;) (ref null $base) (ref null $derived)
        drop
        i32.const -1
        return
      end
    ...
    (func (;1;) (type 2) (param (ref null $base)) (result i32)
      block (result (ref null $base)) ;; label = @1
        local.get 0
        br_on_cast_fail 0 (;@1;) (ref null $base) (ref null $derived)
        struct.get $derived 0
        return
      end
      struct.get $base 0
    )
    (func (;2;) (type 2) (param (ref null $base)) (result i32)
      local.get 0
      ref.test (ref $derived)
    )
    (func (;3;) (type 2) (param (ref null $base)) (result i32)
      local.get 0
      ref.test (ref null $derived)
    )
    (func (;4;) (type 3) (param (ref null $base)) (result (ref $derived))
      local.get 0
      ref.cast (ref $derived)
    )
    (func (;5;) (type 4) (param (ref null $base)) (result (ref null $derived))
      local.get 0
      ref.cast (ref null $derived)
    )
  )
