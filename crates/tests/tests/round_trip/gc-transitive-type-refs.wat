...
(; CHECK-ALL:
  (module
    ...
    (type $outer (;1;) (struct (field (ref null $inner)) (field i32)))
    (type (;2;) (func (param (ref null $inner) i32) (result (ref $outer))))
    (type (;3;) (func (param (ref null $outer)) (result (ref null $inner))))
    (export "make_outer" (func 0))
    (export "get_inner" (func 1))
    (func (;0;) (type 2) (param (ref null $inner) i32) (result (ref $outer))
      local.get 0
      local.get 1
      struct.new $outer
    )
    (func (;1;) (type 3) (param (ref null $outer)) (result (ref null $inner))
      local.get 0
      struct.get $outer 0
    )
    (@producers
